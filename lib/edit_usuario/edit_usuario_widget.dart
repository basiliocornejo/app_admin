...
import 'edit_usuario_model.dart';
export 'edit_usuario_model.dart';
...
class EditUsuarioWidget extends StatefulWidget {
  ...
  @override
  State<EditUsuarioWidget> createState() => _EditUsuarioWidgetState();
}

class _EditUsuarioWidgetState extends State<EditUsuarioWidget> {
  late EditUsuarioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditUsuarioModel());
          ...
          children: [
            ...
            Flexible(
              child: Align(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    await widget!.user!.reference.delete();
                  },
                  text: 'Eliminar',
                  options: FFButtonOptions(
                    width: 206.0,
